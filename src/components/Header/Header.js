    ...
    return (
        <div className="navbar bg-base-100 container mx-auto mb-5">
            <div className="navbar-start">
                ...
                <Link to={user ? "/new-blog" : "/login"} className="lg:hidden ml-24 bg-transparent border-none text-primary  font-normal"><p className='flex items-center gap-3'><IoCreateOutline className='text-xl ' /> Write</p></Link>
            </div>
            ...
            <div className="navbar-end hidden lg:flex">
                ...
                <div className="dropdown dropdown-bottom dropdown-end  px-5">
                    <label tabIndex={0} className="m-1"><Link className="bg-transparent border-none text-primary mr-5 w-5 font-normal"><p><IoNotificationsOutline className='text-xl ' /></p></Link></label>
