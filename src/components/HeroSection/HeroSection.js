...
const HeroSection = () => {
    return (
        <div className="hero min-h-96 bg-primary py-20">
            <div className="hero-content text-center">
                <div className={`max-w-full ${styles.text}`}>
                    <h1 className="text-7xl font-semibold text-accent">Stay curious.</h1>
                    ...
                    <div className="form-control">
                        <label className="input-group flex justify-center my-10">
                            <input type="text" placeholder="example@gmail.com" className="input input-bordered border-warning border-2 focus:outline-none focus-within:shadow-lg w-96" />
