                ...
                <div className="recent">
                    ...
                    <div className="grid grid-cols-2 gap-10">
                        <div className="card w-full h-96 my-10">
                            <img className='rounded-2xl object-cover border-primary border h-96' src={featured[0]?.img} alt="Shoes" />
                            <div className=" mt-5 space-y-2">
                                ...
                                <h2 className="card-title flex justify-between hover:text-primary">
                        ...
                        <div className="flex flex-col gap-5 my-10">
                            {
                                <div className="card card-side bg-base-100">
                                    <img className='rounded-2xl object-cover border-primary border   w-72' src={featured[1]?.img} alt="Movie" />
                                    <div className=" px-5 space-y-3">
                                        ...
                                        <h2 className="card-title hover:text-primary"> <Link to={`content/${featured[1]?._id}`}>{featured[1]?.title} </Link> </h2>
                            ...
                            {
                                <div className="card card-side bg-base-100">
                                    <img className='rounded-2xl object-cover border-primary border   w-72' src={featured[2]?.img} alt="Movie" />
                                    <div className=" px-5 space-y-3">
                                        ...
                                        <h2 className="card-title hover:text-primary"> <Link to={`content/${featured[2]?._id}`}>{featured[2]?.title} </Link> </h2>
                ...
                <div className="all lg:mt-20">
                    ...
                    <div className="grid grid-cols-5 gap-5">
                        <div className="col-span-4 grid grid-cols-3 h-full gap-10">
                            {blogs.length > 0 &&
                                blogs?.map((blog, index) => <div className="card w-full  my-10" key={index}>
                                    <img className='rounded-2xl h-60 object-cover border border-primary' src={blog?.img} alt="Shoes" />
                        ...
                        <div className='border-l-2 pl-5 col-span-1 mt-10'>
                            <div className="flex justify-between">
                                <p className='text-3xl font-semibold'>{blogs?.length} <br />Posts</p>
                                <p className='text-3xl font-semibold'>{writers?.length} <br />Writers</p>
                            </div>
                                            ...
                                            <div className='flex gap-3 justify-center items-start mt-5'>
                                                <div className="avatar">
                                                    <div className="w-20 h-full">
                                                        <img className='rounded-2xl' src={blog?.img} />
                                                    </div>
                                                </div>
                                            ...
                                            <div className='flex gap-3 justify-center items-center mt-5'>
                                                <div className="avatar">
                                                    <div className="w-10 h-10 rounded-full">
                                                        <img className='rounded-2xl' src="https://i.ibb.co/DM3jqw5/Profile-avatar-placeholder-large.png" />
                                                    </div>
                                                </div>
